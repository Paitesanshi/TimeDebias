...
def writer_csv(result_dict,dataset,model,task,case):
    ...
    rootPath = os.path.join(rootPath, 'latent')
    if not os.path.exists(rootPath):
        os.makedirs(rootPath)
...
if __name__ == '__main__':
    ...
    config_dict={
            ...
            "benchmark_filename": [['train_rand_0','valid','test'],
                                   ['train_rand_1','valid','test'],
                                   ['train_rand_2','valid','test'],
                                   ['train_rand_3','valid','test'],
                                   ['train_rand_4','valid','test'],]
            
    }
    if args.config_files.find('dips') != -1:
        task = 'dips'
    elif args.config_files.find('rd_ips')!=-1:
        task='rd_ips'
