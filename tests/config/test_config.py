...
class TestConfigClass(unittest.TestCase):
    ...
    def test_default_settings(self):
        config = Config(model='BPR', dataset='ml-100k_origin')

        self.assertEqual(config['model'], 'BPR')
        self.assertEqual(config['dataset'], 'ml-100k_origin')
    ...
    def test_default_context_settings(self):
        config = Config(model='FM', dataset='ml-100k_origin')
    ...
    def test_default_sequential_settings(self):
        ...
        config = Config(model='SASRec', dataset='ml-100k_origin', config_dict=para_dict)
    ...
    def test_config_file_list(self):
        config = Config(model='BPR', dataset='ml-100k_origin', config_file_list=config_file_list)
    ...
    def test_config_dict(self):
        config = Config(model='BPR', dataset='ml-100k_origin', config_dict=parameters_dict)
